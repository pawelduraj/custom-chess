...
describe('Archbishop', () => {
    ...
    board[18] = {id: 'AB', checkable: false, color: 0, moved: false};

    it('should have 19 possible moves', () => {
        expect(getAllPossibleMoves(18, board, STANDARD_VARIANT)).to.have.lengthOf(19);
    });
    ...
    it('should have 15 possible moves', () => {
        board[36] = {id: 'AB', checkable: false, color: 0, moved: false};
